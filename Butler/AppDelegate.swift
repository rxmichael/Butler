...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func registerNotification() {
        ...
        let settings = UIUserNotificationSettings(forTypes: types, categories: NSSet(object: mapCategory) as? Set<UIUserNotificationCategory>)
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Butler", withExtension: "momd")!
    ...
    func application(application: UIApplication, handleActionWithIdentifier identifier: String?, forLocalNotification notification: UILocalNotification, completionHandler: () -> Void) {
        if identifier == "openAction" {
            ...
            do {
                ...
                let results = try managedObjectContext.executeFetchRequest(request) as! [Item]
